...
def similar(source_sentence):
    ...
    source_sentence = source_sentence.replace("'", "").replace("â", "a").replace("Â", "a").replace("I", "ı").replace("’", "").replace("(", "").replace(")", "").replace("/", " ").replace(",", "").replace("\",", "").replace("\"","").replace(" - ", " ").replace(" -", " ").lower()
